...
class MCPOptimizerExamples:
    ...
    def run_all_examples(self) -> List[ExampleResult]:
        ...
        for example in examples:
            try:
                ...
                self.results.append(ExampleResult(
    ...
    def linear_programming_example(self) -> OptimizationResult:
        ...
        logger.info(f"Production plan: {dict(zip(problem['variable_names'], result.variables))}")
    ...
    def multi_objective_example(self) -> OptimizationResult:
        ...
        problem = {
            "objectives": [
                {"coefficients": [2, 3, 1], "direction": "minimize", "weight": 0.6},  # Cost
                {"coefficients": [1, 2, 3], "direction": "maximize", "weight": 0.4}   # Quality
            ],
            "constraints": [
        ...
        logger.info(f"Pareto optimal solution found")
        logger.info(f"Weighted objective value: {result.objective_value:.2f}")
        
        for name, value in zip(problem["variable_names"], result.variables):
